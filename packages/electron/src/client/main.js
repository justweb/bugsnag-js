...
module.exports = (opts) => {
  ...
  const internalPlugins = [
    ...
    PluginClientStatePersistence(NativeClient, filestore, appRunMetadata),
    require('@bugsnag/plugin-electron-deliver-minidumps')(electron.app, electron.net, filestore, appRunMetadata),
  ...
  bugsnag.lastRunInfo = filestore.getLastRunInfo()
